...
(3) Environment Files:
  ...
  (3a) "Environment output for Plot A only.RData": running output for paper (abundance data for Plot A only).

  (3b) "Environment output for Pool data.RData": running output for appendix (abundance data for Plot A-F).
